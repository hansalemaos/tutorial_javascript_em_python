...
def converter_numeros_para_7a1(n):
    with GetStdOut() as o:
        js2py.eval_js( r'''var ntw;
        ...
        (function() {
            ...
            ntw = numberToWord; console.log(ntw(''' + str(n) + '''));
        }());''' )
    return [l.strip().strip("'") for l in o[0].splitlines()]

for n in range(50):
    result = (converter_numeros_para_7a1(n))
    print(f'{result=}')
